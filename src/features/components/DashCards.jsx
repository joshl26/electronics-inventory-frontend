        ...
        <Row>
          ...
          <Col md={4}>
            <div className="card">
              ...
              <h2 style={{ backgroundColor: 'lightGrey', padding: '1rem' }}>Jobs</h2>
              <div style={{ margin: '0 auto', height: '100%', paddingTop: '50px' }}>
                <Button
                  style={{
                    width: '200px',
                  ...
                  variant="success"
                >
                  <Link to="/jobs/new" style={{ color: 'white', textDecoration: 'none' }}>
                    Schedule a Job
                  </Link>
                </Button>
              </div>
          ...
          <Col md={4}>
            <div className="card">
              ...
              <h2 style={{ backgroundColor: 'lightGrey', padding: '1rem' }}>Schedule</h2>
              <div style={{ margin: '0 auto', height: '100%', paddingTop: '50px' }}>
                <Button
                  style={{
                    width: '200px',
        ...
        <Row>
          ...
          <Col md={4}>
            <div className="card">
              ...
              <h2 style={{ backgroundColor: 'lightGrey', padding: '1rem' }}>Clients</h2>
              <div style={{ margin: '0 auto', height: '100%', paddingTop: '50px' }}>
                <Button
                  style={{
                    width: '200px',
          ...
          <Col md={4}>
            <div className="card">
              ...
              <h2 style={{ backgroundColor: 'lightGrey', padding: '1rem' }}>Settings</h2>
