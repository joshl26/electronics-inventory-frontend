...
export const seoData = {
  home: {
    ...
    keywords:
      "electronics inventory, parts management, component tracking, electronics organization, inventory system",
    structuredData: {
  ...
  features: {
    ...
    description:
      "Discover powerful features including real-time tracking, advanced search, bulk operations, custom categorization, and detailed analytics for your electronics parts inventory.",
    keywords:
      "inventory features, parts tracking, component search, inventory analytics, bulk operations",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "WebPage",
      name: "Features",
  ...
  pricing: {
    ...
    description:
      "Choose the perfect plan for your inventory needs. From free starter plans to enterprise solutions, we have pricing options for individuals, teams, and businesses of all sizes.",
    keywords:
      "pricing plans, subscription, inventory pricing, free plan, enterprise plan",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "WebPage",
      name: "Pricing",
  ...
  privacy: {
    ...
    description:
      "Read our privacy policy to understand how we collect, use, and protect your personal information and inventory data.",
