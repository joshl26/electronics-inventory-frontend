...
export const siteConfig = {
  ...
  site: {
    ...
    description:
      "Electronics parts inventory management system for makers, engineers, and businesses. Track components, organize your workspace, and never lose track of parts again.",
    url: getSiteUrl(),
  ...
  company: {
    ...
    foundingYear: 2022,
    description:
      "We provide inventory management solutions for electronics professionals and hobbyists.",
    address: {
  ...
  seo: {
    ...
    defaultDescription:
      "Manage your electronics parts inventory efficiently with our comprehensive tracking system.",
    keywords: [
