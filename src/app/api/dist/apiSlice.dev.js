...
const _react = require('@reduxjs/toolkit/query/react');

const _authSlice = require('../../features/auth/authSlice');
...
const baseQueryWithReauth = function baseQueryWithReauth(args, api, extraOptions) {
  let result;
  let refreshResult;
...
const apiSlice = (0, _react.createApi)({
