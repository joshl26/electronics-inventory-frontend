...
function CustomerReviews() {
  const data = [
    ...
    },
    {
      ...
      reviewBody: "This app is great for managing inventory - it's user-friendly and effective!",
      reviewRating: {
        bestRating: '5',
        ratingValue: '5',
        worstRating: '1',
    ...
    },
    {
      ...
      reviewBody: "This app is great! It's easy to use and makes inventory related tasks simpler.",
      reviewRating: {
        bestRating: '5',
        ratingValue: '5',
        worstRating: '1',
  ...
  return (
    <div className="slider_container">
      <Container>
        ...
        <h1 className="slider_header_1">Your professional inventory management platform</h1>
        <h3 className="slider_header_2">
          See what people are saying about Electronics Inventory Management and Control Software.
        </h3>
      </Container>
      <div className="spacer_small" />
      <Slide autoplay responsive={responsiveSettings}>
        {data.map((review) => (
          <div
            key={review._id}
